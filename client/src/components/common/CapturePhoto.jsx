...
function CapturePhoto({ hide, setImage }) {
  ...
  const capturePhoto = () => {
    ...
    canvas.getContext("2d").drawImage(videoRef.current, 0, 0, 400, 225);
    setImage(canvas.toDataURL("image/jpeg"));
    hide(false);
  };

  return (
    <div className="absolute h-4/6 w-2/6 top-1/4 left-1/3 bg-grey-900 gap-3 rounded-lg pt-2 flex items-center justify-center">
